...
/**
 * This class is used to provide a Swing radiobutton where its label or text can
...
public class CITRadioButton extends JRadioButton {
    ...
    private CITRadioButton() {}

    // constructor requires text
    public CITRadioButton(String label) {
        super();
